...
game.party.push(pokemon[150], pokemon[140], pokemon[72]);
console.log(game.party);
...
const evolvedForm = pokemon.find(p => p.name === 'Charmeleon');
...
// if (pokemon.starter){
//   console.log('starter')
// return game.party.splice(idx, 1, pokemon[idx+1]);
// }
// })
...
const partyCount = game.partyCount();

console.log(partyCount.count);
